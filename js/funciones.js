...
fetch("https://perenual.com/api/species-list?key=sk-x8SR65ccfe0157bd54158&edible=1&page=3")
    .then((res) => {
    ...
    .then((data) => { //Manejamos la información
        for (let i = 10; i < 20; i++) { //llamamos a la funcion 10 veces, con lo cual nos muestra 10 plantas
